...
class Calculator(QWidget):
    def __init__(self):
        ...
        self.hbox_trid = QHBoxLayout()
        self.hbox_zero = QHBoxLayout()
        self.hbox_math = QHBoxLayout()
        self.hbox_result = QHBoxLayout()

        self.vbox.addLayout(self.hbox_input)
        self.vbox.addLayout(self.hbox_first)
        self.vbox.addLayout(self.hbox_second)
        self.vbox.addLayout(self.hbox_trid)
        self.vbox.addLayout(self.hbox_zero)
        self.vbox.addLayout(self.hbox_math)
        ...
        self.hbox_trid.addWidget(self.b_7)

        self.b_8 = QPushButton("8", self)
        self.hbox_trid.addWidget(self.b_8)

        self.b_9 = QPushButton("9", self)
        self.hbox_trid.addWidget(self.b_9)

        self.b_zero = QPushButton("0", self)
        self.hbox_zero.addWidget(self.b_zero)
        self.b_point = QPushButton(",", self)
        self.hbox_math.addWidget(self.b_point)
        self.b_plus = QPushButton("+", self)
        self.hbox_math.addWidget(self.b_plus)
        self.b_minus = QPushButton("-", self)
        self.hbox_math.addWidget(self.b_minus)
        self.b_multiplication = QPushButton("*", self)
        self.hbox_math.addWidget(self.b_multiplication)
        self.b_division = QPushButton("/", self)
        self.hbox_math.addWidget(self.b_division)
